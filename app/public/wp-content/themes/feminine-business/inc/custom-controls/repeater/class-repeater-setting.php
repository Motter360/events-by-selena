<?php
/**
 * Feminine Business Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Feminine_Business_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Feminine_Business_Repeater_Setting extends WP_Customize_Setting {

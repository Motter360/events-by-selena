...
add_action( 'tgmpa_register', 'feminine_business_register_required_plugins' );
...
if ( ! function_exists( 'feminine_business_register_required_plugins' ) ) {
	function feminine_business_register_required_plugins() {
		...
		$plugins = array(
			array(
				'name'      => __( 'BlossomThemes Email Newsletter', 'feminine-business' ),
				'slug'      => 'blossomthemes-email-newsletter',
				'required'  => false,
			),
			array(
				'name'      => __( 'Woocommerce', 'feminine-business' ),
				'slug'      => 'woocommerce',
				'required'  => false,
			),
			array(
				'name'      => __( 'One Click Demo Import', 'feminine-business' ),
				'slug'      => 'one-click-demo-import',
				'required'  => false,
			),
			array(
				'name'      => __( 'Smash Balloon Social Photo Feed', 'feminine-business' ),
				'slug'      => 'instagram-feed',
				'required'  => false,
			),
			array(
				'name'      => __( 'Contact Form 7', 'feminine-business' ),
				'slug'      => 'contact-form-7',
				'required'  => false,
			),
		);
		 ...
		 */
		$config = array(
			'id'           => 'feminine-business', // Unique ID for hashing notices for multiple instances of TGMPA.

...
if ( ! function_exists( 'feminine_business_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function feminine_business_posted_on() {
...
if ( ! function_exists( 'feminine_business_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function feminine_business_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html_x( '%s', 'post author', 'feminine-business' ),
...
if ( ! function_exists( 'feminine_business_get_fallback_svg' ) ) :    
	/**
	 * Get Fallback SVG
	*/
	function feminine_business_get_fallback_svg( $post_thumbnail ) {
		if( ! $post_thumbnail ){
			return;
		}
	
		$image_size = feminine_business_get_image_sizes( $post_thumbnail );
			
		if( $image_size ){ ?>
			<div class="svg-holder">
				<svg class="fallback-svg" viewBox="0 0 <?php echo esc_attr( $image_size['width'] ); ?> <?php echo esc_attr( $image_size['height'] ); ?>" preserveAspectRatio="none">
					<rect width="<?php echo esc_attr( $image_size['width'] ); ?>" height="<?php echo esc_attr( $image_size['height'] ); ?>" style="fill:#fad2d3"></rect>
				</svg>
			</div>
			<?php
		}
...
if ( ! function_exists( 'feminine_business_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function feminine_business_post_thumbnail() {
			...
			<figure class="post-thumbnail">
				<a href="<?php the_permalink(); ?>">
					<?php if( has_post_thumbnail() ) { ?>
						<?php the_post_thumbnail( 'feminine-business-popular-posts', array( 'itemprop' => 'image' ) );
					}else{
						feminine_business_get_fallback_svg( 'feminine-business-popular-posts' );
					} ?>
				</a>
			</figure>
...
if( ! function_exists( 'feminine_business_get_posts' ) ) :
	/**
	 * Fuction to list Custom Post Type
	*/
	function feminine_business_get_posts( $post_type = 'post', $slug = false ){    
		$args = array(
			'posts_per_page'   => -1,
			'post_type'        => $post_type,
			'post_status'      => 'publish',
		...
		$post_options = array();
		$post_options[''] = __( ' -- Choose -- ', 'feminine-business' );
...
if ( ! function_exists( 'feminine_business_tag' ) ) :
/**
 * Prints tags
 */
function feminine_business_tag(){
	// Hide category and tag text for pages.
	if ( 'post' === get_post_type() ) {
		$tags_list = get_the_tag_list( '', ' ' );
		if ( $tags_list ) {
			/* translators: 1: list of tags. */
			printf( '<div class="cat-tags" itemprop="about">' . esc_html__( '%1$sTags:%2$s %3$s', 'feminine-business' ) . '</div>', '<span class="tags-title">', '</span>', $tags_list );
		}
	}
}
endif;

if( ! function_exists( 'feminine_business_get_svg_icons' ) ) :
	/**
	 * Fuction to list Custom Post Type
	*/
	function feminine_business_get_svg_icons(){    
		...
		// Initate an empty array
		$svg_options = array();
		$svg_options[''] = __( ' -- Choose -- ', 'feminine-business' );
...
if ( ! function_exists( 'feminine_business_social_icons_svg_list' ) ) :    
	/**
	 * Get SVG Image
	*/
	function feminine_business_social_icons_svg_list( $social ){
		...
		switch ( $social ) {
			...
			case 'phone':
				return '<svg xmlns="http://www.w3.org/2000/svg" width="17.962" height="18"
				viewBox="0 0 17.962 18">
				<g id="Group_12" data-name="Group 12" transform="translate(-979.539 -18)">
					<g id="Group_11" data-name="Group 11">
						<path id="Path_9" data-name="Path 9"
							d="M997.03,31.21,994.518,28.7a1.671,1.671,0,0,0-2.781.628,1.709,1.709,0,0,1-1.973,1.077,7.744,7.744,0,0,1-4.665-4.665,1.625,1.625,0,0,1,1.076-1.974,1.671,1.671,0,0,0,.628-2.781l-2.512-2.512a1.791,1.791,0,0,0-2.422,0l-1.705,1.7c-1.7,1.794.18,6.549,4.4,10.765s8.972,6.19,10.766,4.4l1.7-1.705A1.791,1.791,0,0,0,997.03,31.21Z"
							fill="#040505" />
					</g>
				</g>
			</svg>';
			...
			case 'email':
				return '<svg xmlns="http://www.w3.org/2000/svg" width="21" height="14.766"
				viewBox="0 0 21 14.766">
					<g id="Group_10" data-name="Group 10" transform="translate(-1182 -21)">
						<g id="Group_3" data-name="Group 3">
							<g id="Group_2" data-name="Group 2">
								<path id="Path_5" data-name="Path 5"
									d="M1202.815,22.055l-6.369,6.328,6.369,6.328a1.827,1.827,0,0,0,.185-.791V22.846A1.827,1.827,0,0,0,1202.815,22.055Z"
									fill="#040505" />
							</g>
						</g>
						<g id="Group_5" data-name="Group 5">
							<g id="Group_4" data-name="Group 4">
								<path id="Path_6" data-name="Path 6"
									d="M1201.154,21h-17.308a1.829,1.829,0,0,0-.791.185l8.14,8.1a1.847,1.847,0,0,0,2.61,0l8.14-8.1A1.829,1.829,0,0,0,1201.154,21Z"
									fill="#040505" />
							</g>
						</g>
						<g id="Group_7" data-name="Group 7">
							<g id="Group_6" data-name="Group 6">
								<path id="Path_7" data-name="Path 7"
									d="M1182.185,22.055a1.827,1.827,0,0,0-.185.791V33.92a1.827,1.827,0,0,0,.185.791l6.369-6.328Z"
									fill="#040505" />
							</g>
						</g>
						<g id="Group_9" data-name="Group 9">
							<g id="Group_8" data-name="Group 8">
								<path id="Path_8" data-name="Path 8"
									d="M1195.576,29.253l-.9.9a3.08,3.08,0,0,1-4.35,0l-.9-.9-6.369,6.328a1.829,1.829,0,0,0,.791.185h17.308a1.829,1.829,0,0,0,.791-.185Z"
									fill="#040505" />
							</g>
						</g>
					</g>
...
if( ! function_exists( 'feminine_business_misc_svg' ) ) :
    /**
     * Miscellaneous SVG
    */
    function feminine_business_misc_svg( $svg ){
		if( !$svg ){
			return;
		}
		switch ( $svg ) {
            ...
            case 'comment':
				return '<svg xmlns="http://www.w3.org/2000/svg" width="24.37" height="24.552"
			...
			case 'prev-posts':
				return '<svg xmlns="http://www.w3.org/2000/svg" width="6.2" height="11.518"
...
if( ! function_exists( 'feminine_business_get_image_sizes' ) ) :
	/**
	 * Get information about available image sizes
	 */
	function feminine_business_get_image_sizes( $size = '' ) {
...
if( ! function_exists( 'feminine_business_single_reading_calc' ) ) :
    /**
     * Reading calculation
     */
    function feminine_business_single_reading_calc( $content ){ 
		...
		if( $time ){ ?>
            <div class="time">
                <?php echo absint( $time ) . esc_html__( ' Min Read', 'feminine-business' ); ?>
            </div>
        <?php 
		}
    }
...
if ( ! function_exists( 'feminine_business_category' ) ) :
	/**
	 * Prints categories
	 */
	function feminine_business_category(){
		// Hide category and tag text for pages.
		if ( 'post' === get_post_type()) {
			/* translators: used between list items, there is a space after the comma */
			$categories_list = get_the_category();
			if( $categories_list ){
				echo '<span class="category" itemprop="about">';
